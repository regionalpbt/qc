  ...
  if request.method == 'POST':
            ...
            try:    
                ...
                for file in files:                           
                    ...
                    for mf_file in mf_files:
                        if  mf_file.properties["Name"] == file.filename:                            
                            ...
                            return f"Your file name has existed.  Please prefix it with Inspection ID e.g. Final MC#123456 FileName", 501                                                   
                ...
                return "OK",200
                       ...
                       ## Below is to add a log record in case we need to know the attributes of the SharePoint file that has been uploaded.

                format  = "%Y-%m-%dT%H:%M:%SZ" 
                x = datetime2.datetime.now()
                local_date = x.strftime(format)

                col = db["logSharePointDoc"] 
                x = col.insert_one(
